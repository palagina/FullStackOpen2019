...
const Menu = (props) => {
  const {anecdotes, anecdoteById, addNew, setNewAdded, newAdded, setNotification, notification} = props;
  ...
  return (
    ...
    <div>{notification}</div>
      <div>
        ...
        <Link style={style} to="/new">Create new</Link>
      ...
      <Route path="/new" render={() => 
        newAdded ? <Redirect to="/" /> : 
        <CreateNew addNew={addNew} newAdded={newAdded} setNewAdded={setNewAdded} setNotification={setNotification} />} />
...
const CreateNew = (props) => {
  ...
  const {setNewAdded, setNotification} = props;
